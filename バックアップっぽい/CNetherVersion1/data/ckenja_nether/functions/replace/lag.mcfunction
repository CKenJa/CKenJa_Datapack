...
execute if block ~ ~ ~ minecraft:crimson_door[facing=north,half=lower] run setblock ~ ~1 ~ minecraft:crimson_door[facing=north,half=upper]
execute if block ~ ~ ~ minecraft:warped_door[facing=north,half=lower] run setblock ~ ~1 ~ minecraft:warped_door[facing=north,half=upper]
...
execute if block ~ ~ ~ minecraft:crimson_door[facing=south,half=lower] run setblock ~ ~1 ~ minecraft:crimson_door[facing=south,half=upper]
execute if block ~ ~ ~ minecraft:warped_door[facing=south,half=lower] run setblock ~ ~1 ~ minecraft:warped_door[facing=south,half=upper]
...
execute if block ~ ~ ~ minecraft:crimson_door[facing=east,half=lower] run setblock ~ ~1 ~ minecraft:crimson_door[facing=east,half=upper]
execute if block ~ ~ ~ minecraft:warped_door[facing=east,half=lower] run setblock ~ ~1 ~ minecraft:warped_door[facing=east,half=upper]
...
execute if block ~ ~ ~ minecraft:crimson_door[facing=west,half=lower] run setblock ~ ~1 ~ minecraft:crimson_door[facing=west,half=upper]
execute if block ~ ~ ~ minecraft:warped_door[facing=west,half=lower] run setblock ~ ~1 ~ minecraft:warped_door[facing=west,half=upper]
...
execute if block ~ ~ ~ #ckenja_nether:warped/wood[axis=x] run setblock ~ ~ ~ minecraft:warped_hyphae[axis=x]
execute if block ~ ~ ~ #ckenja_nether:crimson/log[axis=x] run setblock ~ ~ ~ minecraft:crimson_stem[axis=x]
execute if block ~ ~ ~ #ckenja_nether:warped/log[axis=x] run setblock ~ ~ ~ minecraft:warped_stem[axis=x]
...
execute if block ~ ~ ~ #ckenja_nether:crimson/log[axis=y] run setblock ~ ~ ~ minecraft:crimson_stem[axis=y]
execute if block ~ ~ ~ #ckenja_nether:warped/log[axis=y] run setblock ~ ~ ~ minecraft:warped_stem[axis=y]
...
execute if block ~ ~ ~ #ckenja_nether:crimson/log[axis=z] run setblock ~ ~ ~ minecraft:crimson_stem[axis=z]
execute if block ~ ~ ~ #ckenja_nether:warped/log[axis=z] run setblock ~ ~ ~ minecraft:warped_stem[axis=z]
...
##北
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=north,open=false] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=north,open=false]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=north,open=false] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=north,open=false]

##南
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=south,open=false] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=south,open=false]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=south,open=false] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=south,open=false]

##東
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=east,open=false] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=east,open=false]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=east,open=false] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=east,open=false]

##西
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=west,open=false] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=west,open=false]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=west,open=false] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=west,open=false]

#開いたトラップドア

##北
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=north,open=true] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=north,open=true]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=north,open=true] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=north,open=true]

##南
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=south,open=true] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=south,open=true]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=south,open=true] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=south,open=true]

##東
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=east,open=true] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=east,open=true]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=east,open=true] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=east,open=true]

##西
execute if block ~ ~ ~ #ckenja_nether:crimson/trapdoor[facing=west,open=true] run setblock ~ ~ ~ minecraft:crimson_trapdoor[facing=west,open=true]
execute if block ~ ~ ~ #ckenja_nether:warped/trapdoor[facing=west,open=true] run setblock ~ ~ ~ minecraft:warped_trapdoor[facing=west,open=true]
