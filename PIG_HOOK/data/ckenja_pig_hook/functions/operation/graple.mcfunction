...
execute at @e[tag=ckenja_pig_hook_aec,distance=..0,limit=1] rotated as @s positioned ^ ^ ^1000 facing entity @s feet positioned ^ ^ ^2000 rotated as @s positioned ^ ^ ^1000 run teleport ~ ~ ~
