execute facing entity @e[tag=ckenja_pig_hook_arg] feet positioned ^ ^ ^8 run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0f,Duration:0,Tags:["ckenja_pig_hook_aec"]}
