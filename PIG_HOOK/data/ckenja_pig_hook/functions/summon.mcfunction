...
summon pig ^ ^ ^1 {Invulnerable:1b,PersistenceRequired:1b,Saddle:1b,Tags:["ckenja_pig_hook_pig","ckenja_pig_hook_pig_initial","ckj03_merge_entitydata","ckj03_fetch_entitydata"],Attributes:[{Name:"generic.movement_speed",Base:1}],DeathLootTable:"minecraft:empty"}
