...
replaceitem entity @p weapon.mainhand minecraft:lingering_potion{display:{Name:"{\"text\":\"Switch Gamemode\",\"color\":\"light_purple\",\"italic\":false}",Lore:["{\"text\":\"ゲームモードを切り替える。\",\"color\":\"white\",\"italic\":false}"]},HideFlags:32,ItemName:Switch_Gamemode,CustomPotionColor:7925247} 1
