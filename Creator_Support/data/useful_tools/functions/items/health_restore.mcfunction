replaceitem entity @p[gamemode=!creative] weapon.mainhand minecraft:lingering_potion{CustomPotionColor: 16711824, HideFlags: 32, display: {Lore: ['{"text":"自身の体力と空腹度を全快する。","color":"white","italic":false}'], Name: '{"text":"Health Restore","color":"light_purple","italic":false}'}, ItemName: "Health_Restore"}
