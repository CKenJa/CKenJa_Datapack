...
# Calc_Vector
execute store result score #ckenja.bread.asa_matrix_x_x AsaMatrix store result score #ckenja.bread.asa_matrix_z_x AsaMatrix run scoreboard players get #asa_move_pos_x AsaMatrix
execute store result score #ckenja.bread.asa_matrix_x_z AsaMatrix store result score #ckenja.bread.asa_matrix_z_z AsaMatrix run scoreboard players get #asa_move_pos_z AsaMatrix
...
scoreboard players operation #ckenja.bread.asa_matrix_z_z AsaMatrix /= #asam_const_1000 AsaMatrix

# Set_Vector
execute store result score #asa_move_pos_temp_x AsaMatrix run scoreboard players get #ckenja.bread.asa_matrix_x_x AsaMatrix
execute store result score #asa_move_pos_temp_z AsaMatrix run scoreboard players get #ckenja.bread.asa_matrix_z_z AsaMatrix