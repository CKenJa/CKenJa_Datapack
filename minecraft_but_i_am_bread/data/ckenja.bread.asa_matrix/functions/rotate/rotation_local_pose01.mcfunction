...
# Calc_Vector
execute store result score #ckenja.bread.asa_matrix_x_x AsaMatrix store result score #ckenja.bread.asa_matrix_z_x AsaMatrix run scoreboard players get #asa_child_pos_x AsaMatrix
execute store result score #ckenja.bread.asa_matrix_x_y AsaMatrix store result score #ckenja.bread.asa_matrix_y_y AsaMatrix store result score #ckenja.bread.asa_matrix_z_y AsaMatrix run scoreboard players get #asa_child_pos_y AsaMatrix
execute store result score #ckenja.bread.asa_matrix_x_z AsaMatrix store result score #ckenja.bread.asa_matrix_y_z AsaMatrix store result score #ckenja.bread.asa_matrix_z_z AsaMatrix run scoreboard players get #asa_child_pos_z AsaMatrix
...
scoreboard players operation #ckenja.bread.asa_matrix_z_x AsaMatrix /= #asam_const_1000 AsaMatrix
...
execute store result score #asa_child_pos_z AsaMatrix run scoreboard players get #ckenja.bread.asa_matrix_z_x AsaMatrix