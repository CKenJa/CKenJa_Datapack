...
# Calc_Vector
execute store result score #ckenja.bread.asa_matrix_x_x AsaMatrix store result score #ckenja.bread.asa_matrix_y_x AsaMatrix run scoreboard players get #ckenja.bread.asa_child_pos_x AsaMatrix
execute store result score #ckenja.bread.asa_matrix_x_y AsaMatrix store result score #ckenja.bread.asa_matrix_y_y AsaMatrix run scoreboard players get #ckenja.bread.asa_child_pos_y AsaMatrix
