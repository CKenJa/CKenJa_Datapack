...
execute store result score #ckenja.bread.asa_matrix_x_z AsaMatrix store result score #ckenja.bread.asa_matrix_z_z AsaMatrix run scoreboard players get #asa_child_pos_z AsaMatrix
...
execute store result score #asa_child_pos_z AsaMatrix run scoreboard players get #ckenja.bread.asa_matrix_z_z AsaMatrix