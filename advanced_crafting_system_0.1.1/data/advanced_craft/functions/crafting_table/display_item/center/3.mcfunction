...
#はじき返し
execute if block ~ ~ ~ barrel{Items:[{Slot:3b}]} run summon item ~ ~1 ~ {Item:{id:"stone",Count:1b,tag:{CustomModelData:1}},Tags:["repitem"]}
...
replaceitem block ~ ~ ~ container.3 black_stained_glass_pane{display:{Name:'{"text":" "}'},ADCcrafter_gui_item:1b} 1
