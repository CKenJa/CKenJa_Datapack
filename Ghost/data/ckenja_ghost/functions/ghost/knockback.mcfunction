...
execute as @e[distance=..1,tag=ckenja_ghost_enemy,limit=1,sort=nearest] store result score #tmp2 ckj01_data run data get entity @s Pos[0] 1000
...
execute as @e[distance=..1,tag=ckenja_ghost_enemy,limit=1,sort=nearest] store result score #tmp2 ckj01_data run data get entity @s Pos[2] 1000
execute positioned ^ ^ ^1 run scoreboard players operation #tmp ckj01_data -= #tmp2 ckj01_data
