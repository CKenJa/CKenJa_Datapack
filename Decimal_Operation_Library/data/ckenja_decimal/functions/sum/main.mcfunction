...
#小さくすると同時に符号処理
    ##符号正転計算はもしMinus:trueならば反転する。
        execute if data storage ckenja_decimal: arg[0].tags{Minus:true} store result storage ckenja_decimal: Sum[{Name:"minecraft:generic.max_health"}].Modifiers[{UUID:[I;404980882,-859879608,-1697797426,491531976]}].Amount double -0.0000001 run attribute @s minecraft:generic.max_health modifier value get 18238492-ccbf-4748-9acd-aace1d4c2ec8
        execute if data storage ckenja_decimal: arg[1].tags{Minus:true} store result storage ckenja_decimal: Sum[{Name:"minecraft:generic.max_health"}].Modifiers[{UUID:[I;404980882,-859879608,-1697797426,491531977]}].Amount double -0.0000001 run attribute @s minecraft:generic.movement_speed modifier value get 18238492-ccbf-4748-9acd-aace1d4c2ec9
        execute unless data storage ckenja_decimal: arg[0].tags{Minus:true} store result storage ckenja_decimal: Sum[{Name:"minecraft:generic.max_health"}].Modifiers[{UUID:[I;404980882,-859879608,-1697797426,491531976]}].Amount double 0.0000001 run attribute @s minecraft:generic.max_health modifier value get 18238492-ccbf-4748-9acd-aace1d4c2ec8
        execute unless data storage ckenja_decimal: arg[1].tags{Minus:true} store result storage ckenja_decimal: Sum[{Name:"minecraft:generic.max_health"}].Modifiers[{UUID:[I;404980882,-859879608,-1697797426,491531977]}].Amount double 0.0000001 run attribute @s minecraft:generic.movement_speed modifier value get 18238492-ccbf-4748-9acd-aace1d4c2ec9
    ##符号反転計算はもしMinus:trueでなければ反転する。
        execute unless data storage ckenja_decimal: arg[0].tags{Minus:true} store result storage ckenja_decimal: Sum[{Name:"minecraft:generic.movement_speed"}].Modifiers[{UUID:[I;404980882,-859879608,-1697797426,491531976]}].Amount double -0.0000001 run attribute @s minecraft:generic.max_health modifier value get 18238492-ccbf-4748-9acd-aace1d4c2ec8
