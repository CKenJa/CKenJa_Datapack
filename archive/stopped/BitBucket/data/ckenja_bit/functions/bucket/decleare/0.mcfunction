data modify storage ckenja_bit: Inventory[{Slot:0b}].id merge from storage ckenja_bit: Inventory[{Slot:-109b}].id
data modify storage ckenja_bit: Inventory[{Slot:0b}].Count merge from storage ckenja_bit: Inventory[{Slot:-109b}].Count
