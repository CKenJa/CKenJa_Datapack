#ckj_smart_devices:core/device/device/general as @s[tag=ckenja_smart_devices_gui] at @s
#GUI構成ごとに別関数、異物を外に排出後、常時置き換え
execute if entity @s[tag=ckenja_smart_devices_gui_3dprinter] run function ckj_smart_devices:core/device/device/gui/layout/3dprinter
#ホッパー使うなカス
