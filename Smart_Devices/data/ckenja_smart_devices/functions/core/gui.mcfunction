...
function #ckenja_smart_devices:core/gui
execute if entity @s[tag=ckenja_smart_devices_gui_3dprinter] run function ckenja_smart_devices:core/gui/3dprinter54
#ホッパー使うなカス
