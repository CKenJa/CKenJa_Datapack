...
execute if score $old.pos.1 ckenja.grapple matches 0 run scoreboard players operation $old.pos1 ckenja.grapple = $pig.pos1 ckenja.grapple
...
execute if score $old.pos.2 ckenja.grapple matches 0 run scoreboard players operation $old.pos2 ckenja.grapple = $pig.pos2 ckenja.grapple
