...
execute store result score #pig.motion.0 ckenja.grapple float run data get storage ckenja.grapple pig.Motion[0] 10
execute store result score #pig.pos.0 ckenja.grapple float run data get storage ckenja.grapple pig.Pos[0] 100
