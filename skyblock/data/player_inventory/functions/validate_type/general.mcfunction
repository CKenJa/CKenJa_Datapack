...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].player_inventory.data[{Slot:9b,tag:{general:{type:"hand"}}}] run function player_inventory:drop/9
#neck10
...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].player_inventory.data[{Slot:10b,tag:{general:{type:"neck"}}}] run function player_inventory:drop/10
#ear11
...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].player_inventory.data[{Slot:11b,tag:{general:{type:"ear"}}}] run function player_inventory:drop/11
#bag12
...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].player_inventory.data[{Slot:12b,tag:{general:{type:"bag"}}}] run function player_inventory:drop/12
#bag13
...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].player_inventory.data[{Slot:13b,tag:{general:{type:"bag"}}}] run function player_inventory:drop/13
#head100
