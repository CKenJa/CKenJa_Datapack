...
execute if entity @s[tag=T_Hard_Slime_Big] run particle instant_effect ~ ~0.8 ~ 0 0 0 0.1 5
execute if entity @s[tag=T_Hard_Slime_Big] run playsound minecraft:entity.slime.attack hostile @a ~ ~ ~ 1.5 0.75
