#チャージ
scoreboard players add @a[scores={Pot_Charge1=1..}] Pot_Charge2 1
scoreboard players reset @a[scores={Pot_Charge1=0}] Pot_Charge2
scoreboard players set @a[scores={Pot_Charge1=1..}] Pot_Charge1 0

#チャージと発射
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=5}] run playsound minecraft:block.stone_button.click_on player @a ~ ~ ~ 1 1
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=10}] run playsound minecraft:block.stone_button.click_on player @a ~ ~ ~ 1 1.5
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=15}] run playsound minecraft:block.stone_button.click_on player @a ~ ~ ~ 1 2
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=15}] run playsound minecraft:block.iron_door.open player @a ~ ~ ~ 1 2
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=15}] positioned ~ ~1.5 ~ run particle crit ^ ^ ^1 0 0 0 0.5 5
execute as @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,PotBowLevel:1b,Charged:0b}}},scores={Pot_Charge2=15}] run replaceitem entity @s weapon.mainhand minecraft:crossbow{ChargedProjectiles:[],Unbreakable:1b,HideFlags:33,Charged:1b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Potion Launcher","color":"aqua","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:1b,Crafted:1b} 
execute as @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,PotBowLevel:2b,Charged:0b}}},scores={Pot_Charge2=15}] run replaceitem entity @s weapon.mainhand minecraft:crossbow{Unbreakable:1b,HideFlags:33,Charged:1b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Multi Potion Launcher","color":"gold","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:2b}
...
#エンダーパール
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b}}},nbt={Inventory:[{Slot:-106b,id:"minecraft:ender_pearl"}]},scores={Used_PotLauncher=1..}] run summon ender_pearl ~ ~1.67 ~ {Tags:["PearlBullet","ItemBullet"]}
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b}}},nbt={Inventory:[{Slot:-106b,id:"minecraft:ender_pearl"}]},scores={Used_PotLauncher=1..}] run playsound minecraft:item.bottle.fill_dragonbreath player @a ~ ~ ~ 2 2
execute at @a[nbt={SelectedItem:{tag:{PotionLauncher:1b}}},nbt={Inventory:[{Slot:-106b,id:"minecraft:ender_pearl"}]},scores={Used_PotLauncher=1..}] run playsound minecraft:entity.arrow.shoot player @a ~ ~ ~ 2 1
execute as @a[nbt={SelectedItem:{tag:{PotionLauncher:1b}}},nbt={Inventory:[{Slot:-106b,id:"minecraft:ender_pearl"}]},scores={Used_PotLauncher=1..}] run clear @s ender_pearl 1
...
#クラフト
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:ender_eye",Count:1b},{Slot:1b,id:"minecraft:gold_ingot",Count:1b},{Slot:2b,id:"minecraft:gold_nugget",Count:1b},{Slot:3b,id:"minecraft:gold_ingot",Count:1b},{Slot:4b,id:"minecraft:bow",Count:1b},{Slot:6b,id:"minecraft:gold_nugget",Count:1b},{Slot:8b,id:"minecraft:repeater",Count:1b}]} run tag @s add Custom_Crafter_Succes
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:ender_eye",Count:1b},{Slot:1b,id:"minecraft:gold_ingot",Count:1b},{Slot:2b,id:"minecraft:gold_nugget",Count:1b},{Slot:3b,id:"minecraft:gold_ingot",Count:1b},{Slot:4b,id:"minecraft:bow",Count:1b},{Slot:6b,id:"minecraft:gold_nugget",Count:1b},{Slot:8b,id:"minecraft:repeater",Count:1b}]} run give @p minecraft:crossbow{ChargedProjectiles:[],Unbreakable:1b,HideFlags:33,Charged:0b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Potion Launcher","color":"aqua","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:1b,Crafted:1b} 
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:ender_eye",Count:1b},{Slot:1b,id:"minecraft:gold_ingot",Count:1b},{Slot:2b,id:"minecraft:gold_nugget",Count:1b},{Slot:3b,id:"minecraft:gold_ingot",Count:1b},{Slot:4b,id:"minecraft:bow",Count:1b},{Slot:6b,id:"minecraft:gold_nugget",Count:1b},{Slot:8b,id:"minecraft:repeater",Count:1b}]} run data merge block ~ ~-1 ~ {Items:{}}
#クラフト（マルチランチャー）
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:experience_bottle",Count:1b},{Slot:1b,id:"minecraft:emerald",Count:1b},{Slot:2b,id:"minecraft:emerald",Count:1b},{Slot:3b,id:"minecraft:emerald",Count:1b},{Slot:4b,id:"minecraft:crossbow",Count:1b,tag:{ChargedProjectiles:[],Unbreakable:1b,HideFlags:33,Charged:0b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Potion Launcher","color":"aqua","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:1b,Crafted:1b}},{Slot:6b,id:"minecraft:emerald",Count:1b},{Slot:8b,id:"minecraft:emerald",Count:1b}]} run tag @s add Custom_Crafter_Succes
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:experience_bottle",Count:1b},{Slot:1b,id:"minecraft:emerald",Count:1b},{Slot:2b,id:"minecraft:emerald",Count:1b},{Slot:3b,id:"minecraft:emerald",Count:1b},{Slot:4b,id:"minecraft:crossbow",Count:1b,tag:{ChargedProjectiles:[],Unbreakable:1b,HideFlags:33,Charged:0b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Potion Launcher","color":"aqua","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:1b,Crafted:1b}},{Slot:6b,id:"minecraft:emerald",Count:1b},{Slot:8b,id:"minecraft:emerald",Count:1b}]} run give @p minecraft:crossbow{Unbreakable:1b,HideFlags:33,Charged:0b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Multi Potion Launcher","color":"gold","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:2b}
execute as @e[tag=Custom_Crafter_Crafting] at @s if block ~ ~-0.5 ~ minecraft:dropper{Items:[{Slot:0b,id:"minecraft:experience_bottle",Count:1b},{Slot:1b,id:"minecraft:emerald",Count:1b},{Slot:2b,id:"minecraft:emerald",Count:1b},{Slot:3b,id:"minecraft:emerald",Count:1b},{Slot:4b,id:"minecraft:crossbow",Count:1b,tag:{ChargedProjectiles:[],Unbreakable:1b,HideFlags:33,Charged:0b,display:{Lore:['{"text":"Sneak to Charge","color":"gray","italic":false}'],Name:'{"text":"Potion Launcher","color":"aqua","italic":false}'},PotionLauncher:1b,Enchantments:[{lvl:-2000s,id:"minecraft:quick_charge"}],Damage:0,PotBowLevel:1b,Crafted:1b}},{Slot:6b,id:"minecraft:emerald",Count:1b},{Slot:8b,id:"minecraft:emerald",Count:1b}]} run data merge block ~ ~-1 ~ {Items:{}}
scoreboard players set @a[nbt={SelectedItem:{tag:{PotionLauncher:1b,Charged:0b}}},scores={Pot_Charge2=15..}] Pot_Charge2 0
scoreboard players reset @a[scores={Used_PotLauncher=1..}] Used_PotLauncher