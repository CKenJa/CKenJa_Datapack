...
data modify storage ckenja_bit: Inventory[{Slot:8b}].tag.ckenja_bit.UUID[0] set from entity @e[tag=ckenja_bit,limit=1] UUID[0]
data modify storage ckenja_bit: Inventory[{Slot:8b}].tag.ckenja_bit.UUID[1] set from entity @e[tag=ckenja_bit,limit=1] UUID[1]
data modify storage ckenja_bit: Inventory[{Slot:8b}].tag.ckenja_bit.UUID[2] set from entity @e[tag=ckenja_bit,limit=1] UUID[2]
data modify storage ckenja_bit: Inventory[{Slot:8b}].tag.ckenja_bit.UUID[3] set from entity @e[tag=ckenja_bit,limit=1] UUID[3]