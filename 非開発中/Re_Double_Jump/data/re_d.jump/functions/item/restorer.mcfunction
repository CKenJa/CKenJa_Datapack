...
execute unless entity @s[scores={C.Cape_R.CT=0..}] positioned ~-0.5 ~ ~-0.5 if entity @a[dx=0] run replaceitem entity @s armor.head air
execute unless entity @s[scores={C.Cape_R.CT=0..}] positioned ~-0.5 ~ ~-0.5 run replaceitem entity @a[nbt={Inventory:[{Slot:102b,tag:{ItemName:Celestial_Feather}}]},dx=0] armor.chest minecraft:elytra{display:{Name:'{"text":"Celestial Feather","color":"aqua","italic":false}',Lore:['{"text":" "}','{"text":"[Passive: Fall Resist,Jump Boost]","color":"white","italic":false}','{"text":"[Jump: Double Jump]","color":"white","italic":false}','{"text":" "}','{"text":"\\"大丈夫、きっとやりとげられる\\"","color":"white","italic":false}']},HideFlags:5,RepairCost:-1000,Unbreakable:1b,ItemName:Celestial_Feather,Enchantments:[{id:"minecraft:unbreaking",lvl:1s}],CustomModelData:1b} 1
...
execute if entity @s[scores={C.Cape_R.CT=80..}] run replaceitem entity @s armor.head lime_stained_glass
