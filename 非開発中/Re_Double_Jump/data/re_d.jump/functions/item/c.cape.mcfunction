...
#壁キック時はなんか特殊なのになる
execute if entity @s[tag=Re_D.Jump_Used,tag=!Re_D.Jump_Wall_2] positioned ~ ~1.67 ~ rotated ~ 0 unless block ^ ^ ^-1 #re_d.jump:wall_latch run replaceitem entity @s armor.chest minecraft:elytra{display:{Name:'{"text":"Celestial Feather","color":"aqua","italic":false}',Lore:['{"text":" "}','{"text":"[Passive: Fall Resist,Jump Boost]","color":"white","italic":false}','{"text":"[Jump: Double Jump]","color":"white","italic":false}','{"text":"[Sneak: Air dash]","color":"white","italic":false}','{"text":" "}','{"text":"\\"大丈夫、きっとやりとげられる\\"","color":"white","italic":false}']},HideFlags:5,RepairCost:-1,Unbreakable:1b,ItemName:Celestial_Feather,ItemMode:Re_D.Jump_Wall,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],CustomModelData:1b} 1
...
execute if entity @s[tag=Re_D.Jump_Wall_2,scores={C.Cape_Delay=2..}] run replaceitem entity @s armor.chest minecraft:elytra{display:{Name:'{"text":"Celestial Feather","color":"aqua","italic":false}',Lore:['{"text":" "}','{"text":"[Passive: Fall Resist,Jump Boost]","color":"white","italic":false}','{"text":"[Jump: Double Jump]","color":"white","italic":false}','{"text":"[Sneak: Air dash]","color":"white","italic":false}','{"text":" "}','{"text":"\\"大丈夫、きっとやりとげられる\\"","color":"white","italic":false}']},HideFlags:5,RepairCost:-1,Unbreakable:1b,ItemName:Celestial_Feather,CustomModelData:1b} 1
