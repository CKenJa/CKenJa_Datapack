...
#ポイント設置/撤去
execute as @e[nbt={Potion:{tag:{ItemName:Re_Place_Jump_Restorer}}}] at @s run function re_d.jump:item/place_restorer
execute as @e[nbt={Item:{tag:{ItemName:Re_Place_Jump_Restorer}}}] at @s run function re_d.jump:item/place_restorer
