...
#10の時：注入開始
execute if score @s ckenja_pot matches 14 run particle item suspicious_stew ~ ~3 ~ 0.005 0.005 0.005 0 16 normal

#30の時：頭スロットを不思議スープに
execute if score @s ckenja_pot matches 20 run replaceitem entity @s armor.head suspicious_stew 1
