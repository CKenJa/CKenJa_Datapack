...
execute store success score #tmp ckenja_ruin run execute if predicate ckj03:sneak run function ckenja_ruin:consume/cancel
execute if score #tmp ckj03_data matches 0 run function ckenja_ruin:consume/not_sneak