...
scoreboard players operation #random ckj01_data = #tmp ckj01_data
scoreboard players add #tmp ckj01_data 1
scoreboard players operation #tmp ckj01_data /= #ckenja_named_denominator ckj01_data
scoreboard players operation #loop_counter ckj01_data = #tmp ckj01_data
execute if score #tmp ckj01_data matches ..0 run function ckenja_named:given/prepend
execute unless score #tmp ckj01_data matches ..0 run function ckenja_named:given/append
#苗字
...
scoreboard players operation #tmp ckj01_data /= #ckenja_named_denominator ckj01_data
scoreboard players operation #loop_counter ckj01_data = #tmp ckj01_data
execute if score #tmp ckj01_data matches ..0 run function ckenja_named:family/prepend
execute unless score #tmp ckj01_data matches ..0 run function ckenja_named:family/append
#称号
...
scoreboard players operation #tmp ckj01_data /= #ckenja_named_denominator ckj01_data
scoreboard players operation #loop_counter ckj01_data = #tmp ckj01_data
execute if score #tmp ckj01_data matches ..0 run function ckenja_named:title/prepend
execute unless score #tmp ckj01_data matches ..0 run function ckenja_named:title/append
#強化
#強化タグをつけるかどうか判定
