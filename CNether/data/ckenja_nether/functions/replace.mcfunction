...
#下が壊れると壊れるブロックを先に置き換える
execute if block ~ ~1 ~ #ckenja_nether:herb if entity @s[predicate=ckenja_nether:crimson] run setblock ~ ~1 ~ minecraft:crimson_fungus
execute if block ~ ~1 ~ #ckenja_nether:herb if entity @s[predicate=ckenja_nether:warped] run setblock ~ ~1 ~ minecraft:warped_fungus
execute if block ~ ~1 ~ minecraft:torch run setblock ~ ~1 ~ minecraft:soul_torch
execute if block ~ ~1 ~ #ckenja_nether:crimson/door if entity @s[predicate=ckenja_nether:crimson] run setblock ~ ~1 ~ minecraft:crimson_door
execute if block ~ ~1 ~ #ckenja_nether:warped/door if entity @s[predicate=ckenja_nether:warped] run setblock ~ ~1 ~ minecraft:warped_door
execute if block ~ ~1 ~ #ckenja_nether:crimson/sign if entity @s[predicate=ckenja_nether:crimson] run setblock ~ ~1 ~ minecraft:crimson_sign
execute if block ~ ~1 ~ #ckenja_nether:warped/sign if entity @s[predicate=ckenja_nether:warped] run setblock ~ ~1 ~ minecraft:warped_sign

#横が壊れると壊れるブロックを先に置き換える
...
execute if block ~1 ~ ~ #minecraft:crops if entity @s[predicate=ckenja_nether:crimson] run setblock ~1 ~ ~ minecraft:nether_wart
...
execute if block ~ ~ ~ #ckenja_nether:crimson/wood if entity @s[predicate=ckenja_nether:crimson] run setblock ~ ~ ~ minecraft:crimson_hyphae
execute if block ~ ~ ~ #ckenja_nether:warped/wood if entity @s[predicate=ckenja_nether:warped] run setblock ~ ~ ~ minecraft:warped_hyphae
