...
#予定データと現在データ取得
execute store result score $tmp2 ckj02_data run data get storage ckenja_anime: Tmp[0].value 100
execute store result score $tmp3 ckj02_data run data get entity @s Rotation[0] 100

#一致したらそのまま、しなかったら計算して代入
